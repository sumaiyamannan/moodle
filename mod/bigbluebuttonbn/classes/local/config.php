...
class config {
    ...
    public static function get_options(): array {
        return [
            ...
            'importpresentationwithannotationsfrombreakoutrooms_editable' =>
                self::get('importpresentationwithannotationsfrombreakoutrooms_editable'),
            'importpresentationwithannotationsfrombreakoutrooms_default' =>
                self::get('importpresentationwithannotationsfrombreakoutrooms_default'),
