...
class mod_bigbluebuttonbn_mod_form extends moodleform_mod {
    ...
    private function bigbluebuttonbn_mform_add_block_room_room(MoodleQuickForm &$mform, array $cfg): void {
        ...
        $field = ['type' => 'hidden', 'name' => 'downloadpresentationwithannotations',
            'data_type' => PARAM_INT, 'description_key' => null];
        ...
        $field = ['type' => 'hidden', 'name' => 'importpresentationwithannotationsfrombreakoutrooms',
            'data_type' => PARAM_INT, 'description_key' => null];
        ...
        $field = ['type' => 'hidden', 'name' => 'importsharednotesfrombreakoutrooms',
            'data_type' => PARAM_INT, 'description_key' => null];
